...
const HomePage = () => {
  ...
  const serviceTeasers = [
    {
      icon: (
        <Cpu
          size={40}
          className="text-krz-primary-green group-hover:text-krz-button-green transition-colors"
        />
      ),
      title: "CNC Machining",
  ...
  return (
    <div id="home" className="space-y-16 md:space-y-24 pb-12 pt-0">
      {" "}
      ...
      >
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Abstract engineering background with sparks and glowing lines"
            src="/assets/images/home.webp"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-krz-primary-green/60 to-krz-text-dark-gray/80"></div>
        </div>
        ...
        >
          ...
          >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-white text-black hover:bg-white hover:text-krz-button-green text-lg py-3 px-8 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <motion.div variants={fadeIn}>
            <img
              ...
              alt="Engineers collaborating over a CAD model on a computer screen"
          ...
          <motion.div variants={fadeIn}>
            ...
            <p className="text-lg text-foreground mb-6">
              KRZ Engineering is at the forefront of mechanical innovation,
              blending cutting-edge technology with profound expertise. We are
              committed to transforming your complex ideas into tangible,
              high-quality realities with precision and efficiency.
            </p>
            <Button
              asChild
              variant="link"
              className="text-krz-button-green hover:text-krz-primary-green text-lg p-0 h-auto font-semibold"
            >
              <RouterLink to="/about">
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-foreground max-w-2xl mx-auto">
            Delivering a comprehensive range of engineering services to meet
            your specific needs. Explore each service to learn more.
          </p>
        </div>
            ...
            <motion.div key={index} variants={fadeIn} className="h-full">
              <Card className="group h-full bg-card hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-krz-light-accent-green/50 hover:border-krz-primary-green">
                <CardHeader className="items-center text-center">
                  ...
                  <CardTitle className="text-xl text-krz-primary-green group-hover:text-krz-button-green transition-colors">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <CardDescription className="text-card-foreground mb-4 min-h-[40px]">
                    {service.description}
                  </CardDescription>
                  <Button
                    asChild
                    variant="ghost"
                    className="text-krz-button-green hover:text-krz-primary-green hover:bg-krz-light-accent-green/50 font-semibold"
                  >
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-foreground max-w-2xl mx-auto">
            A glimpse into the precision and quality we deliver. See more in our
            full portfolio.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          ...
          >
            <RouterLink to="/portfolio">
              View Full Portfolio <Eye className="ml-2 h-5 w-5" />
            </RouterLink>
          </Button>
        </div>
      </motion.section>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Our experts are ready to assist you with your most challenging
            projects.
          </motion.p>
          <motion.div
            variants={fadeIn}
