...
import { Ruler as CadRulerIcon, Layers, Cog, RefreshCw, CheckSquare, ArrowRight, Lightbulb } from 'lucide-react';
...
const serviceDetails = {
  ...
  heroImageQuery: "Modern CAD workstation with complex 3D model on dual monitors",
  heroImageAlt: "Advanced CAD software interface showing a detailed 3D mechanical assembly.",
  description: "KRZ Engineering offers expert Computer-Aided Design (CAD) and prototyping services to bring your ideas from initial sketch to fully realized digital models. Our skilled designers utilize industry-leading software to develop precise 2D drawings and 3D models optimized for manufacturing processes like 3D printing, CNC machining, and laser cutting.",
  keyAspects: [
    { title: "Concept Development", text: "Collaborate with our designers to turn your nascent ideas and sketches into detailed, viable 3D models.", imageQuery: "Designer sketching ideas on a tablet next to a computer with CAD software", imageAlt: "Designer working on initial concept sketches." },
    { title: "Reverse Engineering", text: "We can accurately recreate digital models from existing physical parts, ideal for modifications, improvements, or legacy part replication.", imageQuery: "3D scanner capturing data from a physical object for reverse engineering", imageAlt: "3D scanning process for reverse engineering." },
    { title: "Design for Manufacturability (DfM)", text: "Our designs are not just visually appealing but are optimized for efficient and cost-effective production using your chosen manufacturing method.", imageQuery: "CAD model showing design features optimized for 3D printing supports", imageAlt: "CAD model optimized for manufacturing." },
  ],
  features: [
    { icon: <Layers className="text-krz-primary-green h-6 w-6" />, text: "Parametric 3D Solid Modeling" },
    { icon: <RefreshCw className="text-krz-primary-green h-6 w-6" />, text: "Iterative Design & Prototyping Support" },
    { icon: <Cog className="text-krz-primary-green h-6 w-6" />, text: "Assembly Design & Interference Checking" },
    { icon: <CheckSquare className="text-krz-primary-green h-6 w-6" />, text: "2D Technical Drawing Creation (GD&T)" },
    { icon: <Lightbulb className="text-krz-primary-green h-6 w-6" />, text: "Product Visualization & Rendering" },
    { icon: <CadRulerIcon className="text-krz-primary-green h-6 w-6" />, text: "Custom Solutions for Unique Challenges" },
  ],
};
    ...
    <div className="pt-0">
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-krz-primary-green mb-4">Our CAD Design Process</h2>
          ...
          >
            <div>
              <h3 className="text-2xl font-semibold text-krz-primary-green mb-6">Core CAD Services</h3>
             ...
             <div className="grid grid-cols-1 gap-6">
                <motion.div variants={fadeIn} initial="initial" whileInView="animate" viewport={{ once: true }}>
                    <img  className="rounded-xl shadow-lg object-cover w-full h-64" alt="Complex CAD assembly on a computer screen"  src="https://images.unsplash.com/photo-1666317411591-924603dbe861" />
                </motion.div>
                <motion.div variants={fadeIn} initial="initial" whileInView="animate" viewport={{ once: true }}>
                    <img  className="rounded-xl shadow-lg object-cover w-full h-64" alt="Detailed 2D technical drawing with dimensions"  src="https://images.unsplash.com/photo-1568057373106-63057e421d1c" />
                </motion.div>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-semibold text-krz-primary-green mb-6">Bring Your Designs to Life</h3>
            <p className="text-lg text-foreground max-w-xl mx-auto mb-8">
              Whether you're starting from scratch or need to refine existing designs, our CAD experts are ready to assist.
            </p>
            <Button asChild size="lg" className="bg-krz-button-green hover:bg-krz-primary-green text-white text-lg py-3 px-8 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
              <RouterLink to="/contact">Discuss Your CAD Project <ArrowRight className="ml-2 h-5 w-5" /></RouterLink>
            </Button>
          </motion.div>
        </div>
      </section>
