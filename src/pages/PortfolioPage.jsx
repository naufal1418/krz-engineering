...
const portfolioProjects = [
  {
    ...
    images: [
      {
        id: "1a",
        src: "/assets/images/drone-design.webp",
        alt: "Main view of the custom FDM printed drone chassis",
        query: "Custom FDM 3D printed drone body",
      },
      {
        id: "1b",
        src: "/assets/images/drone-motor.jpg",
        alt: "Close-up of the drone's motor mount",
        query: "Close-up drone motor mount 3d print",
      },
      {
        id: "1c",
        src: "/assets/images/drone-chasis.jpg",
        alt: "Drone chassis during assembly",
        query: "3D printed drone assembly process",
      },
    ],
    mainImageIndex: 0,
  },
  {
    ...
    date: "2025-04-22",
    description:
      "Produced a series of intricate fantasy miniatures for a tabletop game client using SLA resin 3D printing. The focus was on achieving extremely fine details and smooth surfaces suitable for painting. Supported structures were carefully designed to minimize post-processing.",
    technologies: ["SLA 3D Printing", "Digital Sculpting (ZBrush)"],
    materials: ["High-Detail Grey Resin"],
    images: [
      {
        id: "2a",
        src: "/assets/images/3d-printed-miniatures.webp",
        alt: "Group shot of resin printed fantasy miniatures",
        query: "Collection of resin 3D printed miniatures",
      },
      {
        id: "2b",
        src: "/assets/images/miniature-detail.jpg",
        alt: "Close-up of a single detailed miniature",
        query: "Detailed close up of one resin miniature",
      },
    ],
    mainImageIndex: 0,
  },
  {
    id: 3,
    title: "Industrial Steel Brackets",
    ...
    images: [
      {
        id: "3a",
        src: "/assets/images/steel-brackets.jpg",
        alt: "Stack of freshly laser-cut steel brackets",
        query: "Laser cut stainless steel brackets",
      },
      {
        id: "3b",
        src: "/assets/images/welding.webp",
        alt: "Welder working on assembling the brackets",
        query: "Welding steel brackets",
      },
    ],
    mainImageIndex: 0,
  },
  {
    id: 4,
    title: "Engine Assembly CAD Model",
    category: "CAD Models",
    date: "2025-02-05",
    description:
      "Developed a highly detailed 3D CAD model of a V8 engine assembly for a client in the automotive R&D sector. The model included all major components and was used for visualization, interference checking, and as a basis for CFD analysis. Delivered in STEP and SolidWorks native formats.",
    technologies: ["CAD Design (SolidWorks)", "Reverse Engineering (Partial)"],
    materials: ["N/A (Digital Asset)"],
    images: [
      {
        id: "4a",
        src: "/assets/images/v8-cad-design.webp",
        alt: "Rendered image of the V8 engine CAD model",
        query: "Detailed V8 engine CAD model render",
      },
      {
        id: "4b",
        src: "/assets/images/cad-design-cross.jpg",
        alt: "Cross-section view of the engine CAD model",
        query: "Engine CAD model cross section",
      },
      {
        id: "4c",
        src: "/assets/images/exploded-view.jpg",
        alt: "Exploded view of the engine components in CAD",
        query: "Exploded view engine CAD assembly",
      },
    ],
    mainImageIndex: 0,
  },
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            ...
            alt="Collage of various engineering project images"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            Showcasing our expertise in transforming ideas into reality through
              ...
              className={`
                ${
                  selectedCategory === category
                    ? "bg-krz-button-green text-white hover:bg-krz-primary-green"
                    : "text-krz-primary-green border-krz-primary-green hover:bg-krz-light-accent-green/50 hover:text-krz-button-green"
                }
              ...
              >
                <div className="relative aspect-video overflow-hidden">
                  <img
                    ...
                    alt={
                      project.images[project.mainImageIndex]?.alt ||
                      project.title
                    }
                    src={
                      project.images[project.mainImageIndex]?.src || project.src
                    }
                  />
                ...
                <div className="p-4 md:p-6 flex-grow flex flex-col">
                  <h3 className="text-xl font-semibold text-krz-primary-green mb-2 group-hover:text-krz-button-green transition-colors">
                    {project.title}
                  </h3>
                  <Badge
                    variant="secondary"
                    className="mb-3 self-start bg-krz-light-accent-green/50 text-krz-primary-green"
                  >
                    {project.category}
                  </Badge>
                  ...
                  <Button
                    variant="link"
                    className="p-0 h-auto text-krz-button-green self-start font-semibold"
                  >
            ...
            >
              <div className="md:w-1/2 relative bg-black/5">
                <img
                  ...
                  src={
                    ...
                    "https://images.unsplash.com/photo-1542037104857-ffbb0b9155fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGVuZ2luZWVyaW5nJTIwcHJvamVjdHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  }
                />
              ...
              <div className="md:w-1/2 p-6 md:p-8 overflow-y-auto">
                <DialogHeader className="mb-4">
                  <DialogTitle className="text-2xl md:text-3xl font-bold text-krz-primary-green">
                    {selectedProject.title}
                  </DialogTitle>
                  <DialogDescription className="text-sm text-muted-foreground">
                    Category: {selectedProject.category} | Date:{" "}
                ...
                <div className="prose prose-sm max-w-none text-card-foreground">
                  ...
                  <h4 className="font-semibold text-krz-primary-green mt-4 mb-2">
                    Technologies Used:
                  </h4>
                  <div className="flex flex-wrap gap-2 mb-4">
                    {selectedProject.technologies.map((tech) => (
                      <Badge
                        key={tech}
                        variant="outline"
                        className="border-krz-primary-green text-krz-primary-green"
                      >
                        {tech}
                      </Badge>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.materials.map((mat) => (
                      <Badge
                        key={mat}
                        variant="secondary"
                        className="bg-krz-light-accent-green/50 text-krz-primary-green"
                      >
                        {mat}
                      </Badge>
                    ))}
