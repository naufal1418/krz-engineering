...
const servicesData = [
  {
    ...
    shortDescription:
      "Advanced FDM and SLA 3D printing for rapid prototypes, custom parts, and intricate designs. We offer a wide range of materials to meet your specific functional and aesthetic requirements.",
    ...
    src: "/assets/images/3d-printing.webp",
  },
  {
    id: "cad-design",
    ...
    shortDescription:
      "Comprehensive CAD modeling, reverse engineering, and design optimization services. We bridge the gap between concept and production-ready digital blueprints.",
  ...
  },
  {
    ...
    shortDescription:
      "Precision CNC milling and lathe services for robust metal and plastic components. Ideal for functional parts, custom tooling, and high-tolerance applications.",
  ...
  },
  {
    ...
    shortDescription:
      "Accurate laser cutting and intricate engraving for diverse materials including steel, plastics, and wood. Perfect for signage, custom panels, and detailed artwork.",
    ...
    <div className="pt-8 md:pt-12 pb-16">
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            ...
            alt="Grid of various engineering tools and components"
            src="https://images.unsplash.com/photo-1632496497047-706290273235"
          />
        </div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            Precision solutions tailored to your project's unique needs. Explore
            our range of advanced manufacturing capabilities.
          </motion.p>
        </div>
      </motion.section>
      ...
      >
        ...
        >
          ...
          <p className="text-lg md:text-xl text-foreground max-w-3xl mx-auto">
            From initial concept to final product, we offer a comprehensive
            suite of services to bring your visions to life with unmatched
            precision and quality. Click on any service to learn more about how
            we can assist with your specific requirements.
          </p>
        </motion.div>
              ...
              <Card className="group h-full bg-card hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-krz-light-accent-green/50 hover:border-krz-primary-green flex flex-col overflow-hidden">
                ...
                <CardHeader className="items-start text-left pt-6">
                  <div className="flex items-center mb-3">
                    ...
                    <CardTitle className="text-2xl text-krz-primary-green group-hover:text-krz-button-green transition-colors">
                      {service.title}
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="text-left flex-grow flex flex-col">
                  <CardDescription className="text-card-foreground mb-6 flex-grow min-h-[70px]">
                    {service.shortDescription}
                  </CardDescription>
                  <Button
                    asChild
                    variant="default"
                    className="mt-auto bg-krz-button-green hover:bg-krz-primary-green text-white w-full md:w-auto self-start"
                  >
      ...
      <section className="bg-krz-light-background py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Let our expert engineers help you choose the right service and
            materials for your specific application. Contact us today for a
